...
class Interactable {
  public:
     ...
     */
    virtual void sendInteractRequest(
        int playerID) = 0; // Pure virtual function, must be implemented by derived classes
     ...
     */
    virtual void processInteractResult(
        bool state) = 0; // Pure virtual function, must be implemented by derived classes
};
