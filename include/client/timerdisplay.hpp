...
class TimerDisplay : public CanvasElement {
  ...
  private:
    ...
    UITexture backgroundTexture = {"../src/client/ui/timer_background.png",
                                   glm::vec2(1024.0f, 1024.0f), glm::vec2(1024.0f, 1024.0f)};
    ...
    glm::vec2 spriteMap[11] = {
        glm::vec2(128.0f, 0.0f),   glm::vec2(0.0f, 384.0f), glm::vec2(128.0f, 384.0f),
        glm::vec2(256.0f, 384.0f), glm::vec2(0.0f, 256.0f), glm::vec2(128.0f, 256.0f),
        glm::vec2(256.0f, 256.0f), glm::vec2(0.0f, 128.0f), glm::vec2(128.0f, 128.0f),
        glm::vec2(256.0f, 128.0f), glm::vec2(0.0f, 0.0f)};
};
