...
class RigidBody {
  public:
    /**
     * @brief Constructs a RigidBody with specified physical properties and associated transform and
     * collider.
     *
     ...
     *
     * Applies gravity and any accumulated forces, then updates velocity using basic Newtonian
     * physics. Resets the net force afterward.
     *
